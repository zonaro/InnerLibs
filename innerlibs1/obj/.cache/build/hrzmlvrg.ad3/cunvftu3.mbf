...
<html>
  ...
  <head>
    ...
    <title>Class DotObject
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class DotObject
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="InnerLibs.DotObject">
  
  
  <h1 id="InnerLibs_DotObject" data-uid="InnerLibs.DotObject" class="text-break">Class DotObject
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level1"><span class="xref">DotObject</span></div>
      <div class="level2"><a class="xref" href="InnerLibs.Cluster.html">Cluster</a></div>
      <div class="level2"><a class="xref" href="InnerLibs.DotEdge.html">DotEdge</a></div>
      <div class="level2"><a class="xref" href="InnerLibs.DotNode.html">DotNode</a></div>
  </div>
  ...
  <h5 id="InnerLibs_DotObject_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public abstract class DotObject</code></pre>
  </div>
  <h3 id="properties">Properties
  </h3>
  
  
  <a id="InnerLibs_DotObject_Attributes_" data-uid="InnerLibs.DotObject.Attributes*"></a>
  <h4 id="InnerLibs_DotObject_Attributes" data-uid="InnerLibs.DotObject.Attributes">Attributes</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DotAttributeCollection Attributes { get; }</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="InnerLibs.DotAttributeCollection.html">DotAttributeCollection</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="InnerLibs_DotObject_ID_" data-uid="InnerLibs.DotObject.ID*"></a>
  <h4 id="InnerLibs_DotObject_ID" data-uid="InnerLibs.DotObject.ID">ID</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public abstract string ID { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
