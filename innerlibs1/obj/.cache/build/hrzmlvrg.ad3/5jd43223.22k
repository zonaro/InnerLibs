...
<html>
  ...
  <head>
    ...
    <title>Class Map.Marker
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class Map.Marker
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="InnerLibs.GoogleMaps.Map.Marker">
  
  
  <h1 id="InnerLibs_GoogleMaps_Map_Marker" data-uid="InnerLibs.GoogleMaps.Map.Marker" class="text-break">Class Map.Marker
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/InnerLibs.GoogleMaps.Map.Marker.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Marcador da localização no mapa</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritance">
    <h5>Inheritance</h5>
    <div class="level0"><span class="xref">System.Object</span></div>
    <div class="level1"><span class="xref">Map.Marker</span></div>
  </div>
  ...
  <h6><strong>Namespace</strong>: <a class="xref" href="InnerLibs.GoogleMaps.html">InnerLibs.GoogleMaps</a></h6>
  <h6><strong>Assembly</strong>: InnerLibs.dll</h6>
  <h5 id="InnerLibs_GoogleMaps_Map_Marker_syntax">Syntax</h5>
  ...
  <a id="InnerLibs_GoogleMaps_Map_Marker__ctor_" data-uid="InnerLibs.GoogleMaps.Map.Marker.#ctor*"></a>
  <h4 id="InnerLibs_GoogleMaps_Map_Marker__ctor_InnerLibs_Location_System_String_" data-uid="InnerLibs.GoogleMaps.Map.Marker.#ctor(InnerLibs.Location,System.String)">Marker(Location, String)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/InnerLibs.GoogleMaps.Map.Marker.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Cria um marcador</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public Marker(Location Location, string Pin = &quot;&quot;)</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="obj/api/InnerLibs.GoogleMaps.Map.Marker.yml" sourcestartlinenumber="1" sourceendlinenumber="1">&apos;Locaização do Marcador</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">System.String</span></td>
        <td><span class="parametername">Pin</span></td>
        <td><p sourcefile="obj/api/InnerLibs.GoogleMaps.Map.Marker.yml" sourcestartlinenumber="1" sourceendlinenumber="1">Imagem do marcador</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="InnerLibs_GoogleMaps_Map_Marker_Description_" data-uid="InnerLibs.GoogleMaps.Map.Marker.Description*"></a>
  <h4 id="InnerLibs_GoogleMaps_Map_Marker_Description" data-uid="InnerLibs.GoogleMaps.Map.Marker.Description">Description</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/InnerLibs.GoogleMaps.Map.Marker.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Descrição do marcador (balão)</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="InnerLibs_GoogleMaps_Map_Marker_Location_" data-uid="InnerLibs.GoogleMaps.Map.Marker.Location*"></a>
  <h4 id="InnerLibs_GoogleMaps_Map_Marker_Location" data-uid="InnerLibs.GoogleMaps.Map.Marker.Location">Location</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/InnerLibs.GoogleMaps.Map.Marker.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Localizaçao</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public Location Location { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_GoogleMaps_Map_Marker_Pin_" data-uid="InnerLibs.GoogleMaps.Map.Marker.Pin*"></a>
  <h4 id="InnerLibs_GoogleMaps_Map_Marker_Pin" data-uid="InnerLibs.GoogleMaps.Map.Marker.Pin">Pin</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/InnerLibs.GoogleMaps.Map.Marker.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Caminho da imagem do Marcador</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string Pin { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_GoogleMaps_Map_Marker_Title_" data-uid="InnerLibs.GoogleMaps.Map.Marker.Title*"></a>
  <h4 id="InnerLibs_GoogleMaps_Map_Marker_Title" data-uid="InnerLibs.GoogleMaps.Map.Marker.Title">Title</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/InnerLibs.GoogleMaps.Map.Marker.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Titulo do Marcador</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
