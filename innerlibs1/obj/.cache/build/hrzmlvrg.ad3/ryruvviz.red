...
<html>
  ...
  <head>
    ...
    <title>Class MultipleAlternativeQuestion
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class MultipleAlternativeQuestion
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion">
  
  
  <h1 id="InnerLibs_QuestionTest_MultipleAlternativeQuestion" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion" class="text-break">Class MultipleAlternativeQuestion
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/InnerLibs.QuestionTest.MultipleAlternativeQuestion.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Pergunta de Verdadeiro ou Falso. O Usuário deverá assinalar as questões verdadeiras ou falsas correspondente ao enunciado da pergunta.</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritance">
    <h5>Inheritance</h5>
    <div class="level0"><span class="xref">System.Object</span></div>
    <div class="level1"><a class="xref" href="InnerLibs.QuestionTest.Question.html">Question</a></div>
    <div class="level2"><a class="xref" href="InnerLibs.QuestionTest.AlternativeQuestion.html">AlternativeQuestion</a></div>
    <div class="level3"><span class="xref">MultipleAlternativeQuestion</span></div>
  </div>
  <div class="inheritedMembers">
    <h5>Inherited Members</h5>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.AlternativeQuestion.html#InnerLibs_QuestionTest_AlternativeQuestion_Alternatives">AlternativeQuestion.Alternatives</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.AlternativeQuestion.html#InnerLibs_QuestionTest_AlternativeQuestion_RenderAsSelect">AlternativeQuestion.RenderAsSelect</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.AlternativeQuestion.html#InnerLibs_QuestionTest_AlternativeQuestion_AllowMultiple">AlternativeQuestion.AllowMultiple</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.AlternativeQuestion.html#InnerLibs_QuestionTest_AlternativeQuestion_Answer">AlternativeQuestion.Answer</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_QuestionType">Question.QuestionType</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_Test">Question.Test</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_ID">Question.ID</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_Statement">Question.Statement</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_Weight">Question.Weight</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_ToString">Question.ToString()</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_Number">Question.Number</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_Reviewed">Question.Reviewed</a>
    </div>
    <div>
  ...
  <h6><strong>Namespace</strong>: <a class="xref" href="InnerLibs.QuestionTest.html">InnerLibs.QuestionTest</a></h6>
  <h6><strong>Assembly</strong>: InnerLibs.dll</h6>
  <h5 id="InnerLibs_QuestionTest_MultipleAlternativeQuestion_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class MultipleAlternativeQuestion : AlternativeQuestion</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="InnerLibs_QuestionTest_MultipleAlternativeQuestion__ctor_" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion.#ctor*"></a>
  <h4 id="InnerLibs_QuestionTest_MultipleAlternativeQuestion__ctor" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion.#ctor">MultipleAlternativeQuestion()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public MultipleAlternativeQuestion()</code></pre>
  </div>
  <h3 id="properties">Properties
  </h3>
  
  
  <a id="InnerLibs_QuestionTest_MultipleAlternativeQuestion_Hits_" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion.Hits*"></a>
  <h4 id="InnerLibs_QuestionTest_MultipleAlternativeQuestion_Hits" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion.Hits">Hits</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/InnerLibs.QuestionTest.MultipleAlternativeQuestion.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Retorna um numero que representa o quanto o usuario acertou essa pergunta</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public override decimal Hits { get; }</code></pre>
  </div>
  ...
  <div><a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_Hits">Question.Hits</a></div>
  
  
  <a id="InnerLibs_QuestionTest_MultipleAlternativeQuestion_HTML_" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion.HTML*"></a>
  <h4 id="InnerLibs_QuestionTest_MultipleAlternativeQuestion_HTML" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion.HTML">HTML</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">[ScriptIgnore]
public override string HTML { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_HTML">Question.HTML</a></div>
  
  
  <a id="InnerLibs_QuestionTest_MultipleAlternativeQuestion_IsCorrect_" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion.IsCorrect*"></a>
  <h4 id="InnerLibs_QuestionTest_MultipleAlternativeQuestion_IsCorrect" data-uid="InnerLibs.QuestionTest.MultipleAlternativeQuestion.IsCorrect">IsCorrect</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/InnerLibs.QuestionTest.MultipleAlternativeQuestion.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Verifica se a pergunta está corretamente assinalada</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public override bool IsCorrect { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="InnerLibs.QuestionTest.Question.html#InnerLibs_QuestionTest_Question_IsCorrect">Question.IsCorrect</a></div>
