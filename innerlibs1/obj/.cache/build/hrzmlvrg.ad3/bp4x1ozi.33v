...
<html>
  ...
  <head>
    ...
    <title>Class Bootstrap.Panel
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class Bootstrap.Panel
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel">
  
  
  <h1 id="InnerLibs_Bootstrap_Bootstrap_Panel" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel" class="text-break">Class Bootstrap.Panel
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/InnerLibs.Bootstrap.Bootstrap.Panel.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Elemento Panel do Bootstrap</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritance">
    <h5>Inheritance</h5>
    <div class="level0"><span class="xref">System.Object</span></div>
    <div class="level1"><a class="xref" href="InnerLibs.Bootstrap.Bootstrap.BootstrapElement.html">Bootstrap.BootstrapElement</a></div>
    <div class="level2"><span class="xref">Bootstrap.Panel</span></div>
  </div>
  <div class="inheritedMembers">
    <h5>Inherited Members</h5>
    <div>
      <a class="xref" href="InnerLibs.Bootstrap.Bootstrap.BootstrapElement.html#InnerLibs_Bootstrap_Bootstrap_BootstrapElement_OuterHtml">Bootstrap.BootstrapElement.OuterHtml</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.Bootstrap.Bootstrap.BootstrapElement.html#InnerLibs_Bootstrap_Bootstrap_BootstrapElement_InnerHtml">Bootstrap.BootstrapElement.InnerHtml</a>
    </div>
    <div>
      <a class="xref" href="InnerLibs.Bootstrap.Bootstrap.BootstrapElement.html#InnerLibs_Bootstrap_Bootstrap_BootstrapElement_CreateObjectClass_InnerLibs_Bootstrap_Bootstrap_ElementType_">Bootstrap.BootstrapElement.CreateObjectClass(Bootstrap.ElementType)</a>
    </div>
    <div>
  ...
  <h6><strong>Namespace</strong>: <a class="xref" href="InnerLibs.Bootstrap.html">InnerLibs.Bootstrap</a></h6>
  <h6><strong>Assembly</strong>: InnerLibs.dll</h6>
  <h5 id="InnerLibs_Bootstrap_Bootstrap_Panel_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class Panel : Bootstrap.BootstrapElement</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="InnerLibs_Bootstrap_Bootstrap_Panel__ctor_" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.#ctor*"></a>
  <h4 id="InnerLibs_Bootstrap_Bootstrap_Panel__ctor_System_String_System_String_" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.#ctor(System.String,System.String)">Panel(String, String)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public Panel(string Title, string Footer = null)</code></pre>
  </div>
  ...
  <a id="InnerLibs_Bootstrap_Bootstrap_Panel_Content_" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.Content*"></a>
  <h4 id="InnerLibs_Bootstrap_Bootstrap_Panel_Content" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.Content">Content</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="InnerLibs_Bootstrap_Bootstrap_Panel_Footer_" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.Footer*"></a>
  <h4 id="InnerLibs_Bootstrap_Bootstrap_Panel_Footer" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.Footer">Footer</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="InnerLibs_Bootstrap_Bootstrap_Panel_Title_" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.Title*"></a>
  <h4 id="InnerLibs_Bootstrap_Bootstrap_Panel_Title" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.Title">Title</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="InnerLibs_Bootstrap_Bootstrap_Panel_Type_" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.Type*"></a>
  <h4 id="InnerLibs_Bootstrap_Bootstrap_Panel_Type" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.Type">Type</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public Bootstrap.ElementType Type { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="InnerLibs.Bootstrap.Bootstrap.ElementType.html">Bootstrap.ElementType</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="InnerLibs_Bootstrap_Bootstrap_Panel_ToString_" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.ToString*"></a>
  <h4 id="InnerLibs_Bootstrap_Bootstrap_Panel_ToString_System_String_System_String_System_String_" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.ToString(System.String,System.String,System.String)">ToString(String, String, String)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string ToString(string ID = &quot;&quot;, string Class = &quot;&quot;, string Attributes = &quot;&quot;)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_Bootstrap_Bootstrap_Panel_TransformElement_" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.TransformElement*"></a>
  <h4 id="InnerLibs_Bootstrap_Bootstrap_Panel_TransformElement_System_Web_UI_HtmlControls_HtmlGenericControl__" data-uid="InnerLibs.Bootstrap.Bootstrap.Panel.TransformElement(System.Web.UI.HtmlControls.HtmlGenericControl@)">TransformElement(ref HtmlGenericControl)</h4>
  <div class="markdown level1 summary"><p sourcefile="obj/api/InnerLibs.Bootstrap.Bootstrap.Panel.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Transforma um elemento em um Panel do Bootstrap</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public void TransformElement(ref HtmlGenericControl Control)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="obj/api/InnerLibs.Bootstrap.Bootstrap.Panel.yml" sourcestartlinenumber="1" sourceendlinenumber="1">Elemento que vai sofrer a transformação</p>
</td>
      </tr>
    </tbody>
  </table>
