...
<html>
  ...
  <head>
    ...
    <title>Class CssSelector
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class CssSelector
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="InnerLibs.HtmlParser.CssSelector">
  
  
  <h1 id="InnerLibs_HtmlParser_CssSelector" data-uid="InnerLibs.HtmlParser.CssSelector" class="text-break">Class CssSelector
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level1"><span class="xref">CssSelector</span></div>
  </div>
  ...
  <h5 id="InnerLibs_HtmlParser_CssSelector_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public abstract class CssSelector</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="InnerLibs_HtmlParser_CssSelector__ctor_" data-uid="InnerLibs.HtmlParser.CssSelector.#ctor*"></a>
  <h4 id="InnerLibs_HtmlParser_CssSelector__ctor" data-uid="InnerLibs.HtmlParser.CssSelector.#ctor">CssSelector()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public CssSelector()</code></pre>
  </div>
  <h3 id="properties">Properties
  </h3>
  
  
  <a id="InnerLibs_HtmlParser_CssSelector_AllowTraverse_" data-uid="InnerLibs.HtmlParser.CssSelector.AllowTraverse*"></a>
  <h4 id="InnerLibs_HtmlParser_CssSelector_AllowTraverse" data-uid="InnerLibs.HtmlParser.CssSelector.AllowTraverse">AllowTraverse</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public virtual bool AllowTraverse { get; }</code></pre>
  </div>
  ...
  <a id="InnerLibs_HtmlParser_CssSelector_IsSubSelector_" data-uid="InnerLibs.HtmlParser.CssSelector.IsSubSelector*"></a>
  <h4 id="InnerLibs_HtmlParser_CssSelector_IsSubSelector" data-uid="InnerLibs.HtmlParser.CssSelector.IsSubSelector">IsSubSelector</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">protected virtual bool IsSubSelector { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_HtmlParser_CssSelector_Selector_" data-uid="InnerLibs.HtmlParser.CssSelector.Selector*"></a>
  <h4 id="InnerLibs_HtmlParser_CssSelector_Selector" data-uid="InnerLibs.HtmlParser.CssSelector.Selector">Selector</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string Selector { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_HtmlParser_CssSelector_SubSelectors_" data-uid="InnerLibs.HtmlParser.CssSelector.SubSelectors*"></a>
  <h4 id="InnerLibs_HtmlParser_CssSelector_SubSelectors" data-uid="InnerLibs.HtmlParser.CssSelector.SubSelectors">SubSelectors</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public IList&lt;CssSelector&gt; SubSelectors { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Collections.Generic.IList</span>&lt;<a class="xref" href="InnerLibs.HtmlParser.CssSelector.html">CssSelector</a>&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="InnerLibs_HtmlParser_CssSelector_Token_" data-uid="InnerLibs.HtmlParser.CssSelector.Token*"></a>
  <h4 id="InnerLibs_HtmlParser_CssSelector_Token" data-uid="InnerLibs.HtmlParser.CssSelector.Token">Token</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public abstract string Token { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_HtmlParser_CssSelector_FilterCore_" data-uid="InnerLibs.HtmlParser.CssSelector.FilterCore*"></a>
  <h4 id="InnerLibs_HtmlParser_CssSelector_FilterCore_InnerLibs_HtmlParser_HtmlNodeCollection_" data-uid="InnerLibs.HtmlParser.CssSelector.FilterCore(InnerLibs.HtmlParser.HtmlNodeCollection)">FilterCore(HtmlNodeCollection)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">protected abstract HtmlNodeCollection FilterCore(HtmlNodeCollection currentNodes)</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><span class="parametername">currentNodes</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
