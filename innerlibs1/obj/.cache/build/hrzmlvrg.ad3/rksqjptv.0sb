...
<html>
  ...
  <head>
    ...
    <title>Class BitLy.ShortUrl.ShortUrlData
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class BitLy.ShortUrl.ShortUrlData
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData">
  
  
  <h1 id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData" class="text-break">Class BitLy.ShortUrl.ShortUrlData
  </h1>
  <div class="markdown level0 summary"><p sourcefile="obj/api/InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Data da URL Encurtada</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritance">
    <h5>Inheritance</h5>
    <div class="level0"><span class="xref">System.Object</span></div>
    <div class="level1"><span class="xref">BitLy.ShortUrl.ShortUrlData</span></div>
  </div>
  ...
  <h6><strong>Namespace</strong>: <a class="xref" href="InnerLibs.BitLy.html">InnerLibs.BitLy</a></h6>
  <h6><strong>Assembly</strong>: InnerLibs.dll</h6>
  <h5 id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public sealed class ShortUrlData</code></pre>
  </div>
  <h3 id="properties">Properties
  </h3>
  
  
  <a id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_global_hash_" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.global_hash*"></a>
  <h4 id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_global_hash" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.global_hash">global_hash</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string global_hash { get; set; }</code></pre>
  </div>
  ...
  <a id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_hash_" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.hash*"></a>
  <h4 id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_hash" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.hash">hash</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_long_url_" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.long_url*"></a>
  <h4 id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_long_url" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.long_url">long_url</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string long_url { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_new_hash_" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.new_hash*"></a>
  <h4 id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_new_hash" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.new_hash">new_hash</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public int new_hash { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_url_" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.url*"></a>
  <h4 id="InnerLibs_BitLy_BitLy_ShortUrl_ShortUrlData_url" data-uid="InnerLibs.BitLy.BitLy.ShortUrl.ShortUrlData.url">url</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
