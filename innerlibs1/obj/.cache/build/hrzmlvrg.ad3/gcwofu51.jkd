...
<html>
  ...
  <head>
    ...
    <title>Class StilingueAPI.WarRoom.News
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class StilingueAPI.WarRoom.News
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News">
  
  
  <h1 id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News" class="text-break">Class StilingueAPI.WarRoom.News
  </h1>
  <div class="markdown level0 summary"><p>Noticias e publicações em Redes Sociais</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritance">
    <h5>Inheritance</h5>
    <div class="level0"><span class="xref">System.Object</span></div>
    <div class="level1"><span class="xref">StilingueAPI.WarRoom.News</span></div>
  </div>
  ...
  <h5 id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class News</code></pre>
  </div>
  <h3 id="properties">Properties
  </h3>
  
  
  <a id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News_Limit_" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News.Limit*"></a>
  <h4 id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News_Limit" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News.Limit">Limit</h4>
  ...
  <a id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News_Next_Offset_" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News.Next_Offset*"></a>
  <h4 id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News_Next_Offset" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News.Next_Offset">Next_Offset</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public int Next_Offset { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News_Offset_" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News.Offset*"></a>
  <h4 id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News_Offset" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News.Offset">Offset</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News_Posts_" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News.Posts*"></a>
  <h4 id="InnerLibs_Stilingue_StilingueAPI_WarRoom_News_Posts" data-uid="InnerLibs.Stilingue.StilingueAPI.WarRoom.News.Posts">Posts</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public List&lt;StilingueAPI.WarRoom.Post&gt; Posts { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Collections.Generic.List</span>&lt;<a class="xref" href="InnerLibs.Stilingue.StilingueAPI.WarRoom.Post.html">StilingueAPI.WarRoom.Post</a>&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
