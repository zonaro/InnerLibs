...
<html>
  ...
  <head>
    ...
    <meta name="title" content="Class DotEdge
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="InnerLibs.DotEdge">
  
  
  <h1 id="InnerLibs_DotEdge" data-uid="InnerLibs.DotEdge" class="text-break">Class DotEdge
  </h1>
  <div class="markdown level0 summary"><p>Representa uma ligação entre nós de um grafico em DOT Language</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritance">
    <h5>Inheritance</h5>
    <div class="level0"><span class="xref">System.Object</span></div>
    <div class="level1"><a class="xref" href="InnerLibs.DotObject.html">DotObject</a></div>
    <div class="level2"><span class="xref">DotEdge</span></div>
  </div>
  <div class="inheritedMembers">
    <h5>Inherited Members</h5>
    <div>
      <a class="xref" href="InnerLibs.DotObject.html#InnerLibs_DotObject_Attributes">DotObject.Attributes</a>
    </div>
    <div>
  ...
  <h5 id="InnerLibs_DotEdge_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class DotEdge : DotObject</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="InnerLibs_DotEdge__ctor_" data-uid="InnerLibs.DotEdge.#ctor*"></a>
  <h4 id="InnerLibs_DotEdge__ctor_InnerLibs_DotNode_InnerLibs_DotNode_System_Boolean_" data-uid="InnerLibs.DotEdge.#ctor(InnerLibs.DotNode,InnerLibs.DotNode,System.Boolean)">DotEdge(DotNode, DotNode, Boolean)</h4>
  <div class="markdown level1 summary"><p>Cria uma nova ligaçao </p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DotEdge(DotNode ParentNode, DotNode ChildNode, bool Oriented = true)</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="InnerLibs.DotNode.html">DotNode</a></td>
        <td><span class="parametername">ParentNode</span></td>
        <td></td>
      </tr>
      <tr>
        <td><a class="xref" href="InnerLibs.DotNode.html">DotNode</a></td>
        <td><span class="parametername">ChildNode</span></td>
        <td></td>
      </tr>
      <tr>
        <td><span class="xref">System.Boolean</span></td>
        <td><span class="parametername">Oriented</span></td>
        <td><p>Relação orientada</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="InnerLibs_DotEdge_ChildNode_" data-uid="InnerLibs.DotEdge.ChildNode*"></a>
  <h4 id="InnerLibs_DotEdge_ChildNode" data-uid="InnerLibs.DotEdge.ChildNode">ChildNode</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DotNode ChildNode { get; set; }</code></pre>
  </div>
  ...
  <a id="InnerLibs_DotEdge_ID_" data-uid="InnerLibs.DotEdge.ID*"></a>
  <h4 id="InnerLibs_DotEdge_ID" data-uid="InnerLibs.DotEdge.ID">ID</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <div><a class="xref" href="InnerLibs.DotObject.html#InnerLibs_DotObject_ID">DotObject.ID</a></div>
  
  
  <a id="InnerLibs_DotEdge_Oriented_" data-uid="InnerLibs.DotEdge.Oriented*"></a>
  <h4 id="InnerLibs_DotEdge_Oriented" data-uid="InnerLibs.DotEdge.Oriented">Oriented</h4>
  <div class="markdown level1 summary"><p>Indica se esta ligação é orientada ou não</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public bool Oriented { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_DotEdge_ParentNode_" data-uid="InnerLibs.DotEdge.ParentNode*"></a>
  <h4 id="InnerLibs_DotEdge_ParentNode" data-uid="InnerLibs.DotEdge.ParentNode">ParentNode</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DotNode ParentNode { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_DotEdge_ToString_" data-uid="InnerLibs.DotEdge.ToString*"></a>
  <h4 id="InnerLibs_DotEdge_ToString" data-uid="InnerLibs.DotEdge.ToString">ToString()</h4>
  <div class="markdown level1 summary"><p>Escreve a DOT String desta ligaçao</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
