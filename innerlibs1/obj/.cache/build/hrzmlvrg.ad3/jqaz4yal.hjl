...
<html>
  ...
  <head>
    ...
    <title>Class AsxEntry
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class AsxEntry
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="InnerLibs.AsxEntry">
  
  
  <h1 id="InnerLibs_AsxEntry" data-uid="InnerLibs.AsxEntry" class="text-break">Class AsxEntry
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level1"><span class="xref">AsxEntry</span></div>
  </div>
  ...
  <h5 id="InnerLibs_AsxEntry_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class AsxEntry</code></pre>
  </div>
  <h3 id="properties">Properties
  </h3>
  
  
  <a id="InnerLibs_AsxEntry_Author_" data-uid="InnerLibs.AsxEntry.Author*"></a>
  <h4 id="InnerLibs_AsxEntry_Author" data-uid="InnerLibs.AsxEntry.Author">Author</h4>
  ...
  <a id="InnerLibs_AsxEntry_Copyright_" data-uid="InnerLibs.AsxEntry.Copyright*"></a>
  <h4 id="InnerLibs_AsxEntry_Copyright" data-uid="InnerLibs.AsxEntry.Copyright">Copyright</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string Copyright { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="InnerLibs_AsxEntry_Title_" data-uid="InnerLibs.AsxEntry.Title*"></a>
  <h4 id="InnerLibs_AsxEntry_Title" data-uid="InnerLibs.AsxEntry.Title">Title</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="InnerLibs_AsxEntry_URL_" data-uid="InnerLibs.AsxEntry.URL*"></a>
  <h4 id="InnerLibs_AsxEntry_URL" data-uid="InnerLibs.AsxEntry.URL">URL</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public Uri URL { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
