...
Namespace QueryLibrary
    Public NotInheritable Partial Class Query
        ...
        ''' Throws UnexpectedNumberOfRowsSelected if the number of selected rows is less than N.
        ...
        ''' If the number of selected rows is less than N
        ''' </exception>
        Public Function SelectNoLessThan(ByVal n As Integer, ByVal sql As String, ByVal Optional parameters As Object = Nothing) As DataTable
            If _disposed Then Throw New ObjectDisposedException([GetType]().FullName)
            Return WithReturn(sql, parameters, CountValidationEnum.NoLessThan, n)
        End Function
        ...
        ''' </exception>
        Public Function SelectNoLessThan(Of T As New)(ByVal n As Integer, ByVal sql As String, ByVal Optional parameters As Object = Nothing) As IEnumerable(Of T)
            If _disposed Then Throw New ObjectDisposedException([GetType]().FullName)
