...
Namespace EscPosCommands
    Friend Class BarCode
        ...
        Public Function Code128(ByVal code As String) As Byte() Implements IBarCode.Code128
            Return New Byte() {29, 119, 2}.AddBytes((New Byte() {29, 104, 50})).AddBytes((New Byte() {29, 102, 1})).AddBytes((New Byte() {29, 72, 0})).AddBytes((New Byte() {29, 107, 73})).AddBytes({CByte(code.Length + 2)}).AddBytes((New Byte() {123, 66})).AddBytes(code) ' Width
            ' Height
            ' font hri character
        ...
        Public Function Ean13(ByVal code As String) As Byte() Implements IBarCode.Ean13
            ...
            Return New Byte() {29, 119, 2}.AddBytes((New Byte() {29, 104, 50})).AddBytes((New Byte() {29, 72, 0})).AddBytes((New Byte() {29, 107, 67, 12})).AddBytes(code.Substring(0, 12)) ' Width
            ' Height
            ' If print code informed
        End Function
    End Class
