...
Namespace EscDarumaCommands
    ...
    Friend Class BarCode
        ...
        Public Function Code128(ByVal code As String) As Byte() Implements IBarCode.Code128
            Return New Byte() {27, "b"c.ToByte, 5}.AddBytes((New Byte() {2})).AddBytes((New Byte() {50})).AddBytes((New Byte() {0})).AddBytes(code).AddBytes(New Byte() {0}) ' Code Type
            ' Witdh
            ' Height
        ...
        Public Function Code39(ByVal code As String) As Byte() Implements IBarCode.Code39
            Return New Byte() {27, "b"c.ToByte, 6}.AddBytes((New Byte() {2})).AddBytes((New Byte() {50})).AddBytes((New Byte() {0})).AddBytes(code).AddBytes(New Byte() {0}) ' Code Type
            ' Witdh
            ' Height
            ' If print code informed (1 print, 0 dont print)
        End Function
        ...
        Public Function Ean13(ByVal code As String) As Byte() Implements IBarCode.Ean13
            ...
            Return New Byte() {27, "b"c.ToByte(), 1}.AddBytes((New Byte() {2})).AddBytes((New Byte() {50})).AddBytes((New Byte() {0})).AddBytes(code.Substring(0, 12)).AddBytes(New Byte() {0}) ' Code Type
            ' Witdh
            ' Height
            ' If print code informed (1 print, 0 dont print)
        End Function
