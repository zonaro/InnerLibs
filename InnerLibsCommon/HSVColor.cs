...
namespace InnerLibs
{
    ...
    public class HSVColor : IComparable<int>, IComparable<HSVColor>, IComparable<Color>, IComparable, ICloneable
    {
        ...
        /// <returns></returns>
        public static HSVColor FromImage(Image Img, int Reduce = 16) => Ext.ColorPallette(Img, Reduce).Keys.FirstOr(new HSVColor());
        ...
        /// <param name="Name"></param>
        /// <returns></returns>
        public static HSVColor RandomTransparentColor(string Name = null) => RandomColor().With(x => x.Opacity = Ext.RandomNumber(0, 100)).With(x => x.Name = Name);
        ...
        public Bitmap CreateSolidImage(string Size = InnerLibs.Ext.EmptyString)
        {
        ...
        {
            var c = CreateCopy();
            c.Red = Ext.RoundInt(Red * 0.393d + Green * 0.769d + Blue * 0.189d);
            c.Green = Ext.RoundInt(Red * 0.349d + Green * 0.686d + Blue * 0.168d);
            c.Blue = Ext.RoundInt(Red * 0.272d + Green * 0.534d + Blue * 0.131d);
            return c;
        }
