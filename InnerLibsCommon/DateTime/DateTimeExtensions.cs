    ...
    public class PeriodFormat
    {
        ...
        public Expression<Func<T, string>> GroupByPeriodExpression<T>(string Group, Expression<Func<T, DateTime>> prop)
        {
            ...
            switch (Group.ToLowerInvariant().RemoveAccents())
            {
                ...
                case "mensal":
                case "mes":
                    method = typeof(Util).GetMethod(nameof(Util.MonthString), new[] { typeof(DateTime), typeof(string), typeof(CultureInfo) });
                ...
                case "week":
                case "semana":
                    method = typeof(Util).GetMethod(nameof(Util.WeekString), new[] { typeof(DateTime), typeof(string), typeof(CultureInfo) });
                ...
                case "fortnight":
                case "quinzena":
                    method = typeof(Util).GetMethod(nameof(Util.FortnightString), new[] { typeof(DateTime), typeof(string), typeof(CultureInfo) });
                ...
                case "bimester":
                case "bimestre":
                    method = typeof(Util).GetMethod(nameof(Util.BimesterString), new[] { typeof(DateTime), typeof(string) });
                ...
                case "quarter":
                case "trimestre":
                    method = typeof(Util).GetMethod(nameof(Util.QuarterString), new[] { typeof(DateTime), typeof(string) });
                ...
                case "semester":
                case "semestre":
                    method = typeof(Util).GetMethod(nameof(Util.SemesterString), new[] { typeof(DateTime), typeof(string) });
                ...
                case "year":
                case "ano":
                    method = typeof(Util).GetMethod(nameof(Util.YearString), new[] { typeof(DateTime), typeof(string) });
                ...
                case "day":
                case "dia":
                    method = typeof(Util).GetMethod(nameof(Util.DayString), new[] { typeof(DateTime), typeof(string), typeof(CultureInfo) });
