...
namespace InnerLibs
{
    ...
    public class DateRangeDisplay
    {
        ...
        public override string ToString() => new string[] { YearsWord.Plural, MonthsWord.Plural, DaysWord.Plural, HoursWord.Plural, MinutesWord.Plural, SecondsWord.Plural, MillisecondsWord.Plural }.ToPhrase(InnerLibs.Ext.EmptyString, AndWord);
