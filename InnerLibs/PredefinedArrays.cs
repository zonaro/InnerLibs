...
namespace InnerLibs
{
    ...
    public static class PredefinedArrays
    {
        ...
        public static IEnumerable<string> CloseWrappers => new[] { Util.DoubleQuoteChar, InnerLibs.Util.SingleQuoteChar, ")", "}", "]", ">", "`" }.AsEnumerable();
        ...
        public static IEnumerable<string> OpenWrappers => new[] { Util.DoubleQuoteChar, InnerLibs.Util.SingleQuoteChar, "(", "{", "[", "<", "`" }.AsEnumerable();
