    ...
    public static class DateTimeOffsetExtensions
    {
        ...
        public static DateTimeOffset AddBusinessDays(this DateTimeOffset current, int days)
        {
            ...
            for (var i = 0; i < unsignedDays; i++)
            {
                ...
                } while (current.DayOfWeek.IsIn(DayOfWeek.Saturday, DayOfWeek.Sunday));
            }
        ...
        /// </summary>
        public static DateTimeOffset AddDateRange(this DateTimeOffset dateTimeOffset, DateRange timeSpan)
        {
        ...
        /// <summary>
        /// Obsolete. This method has been renamed to FirstDayOfWeek to be more consistent with
        ...
        /// cref="DateRange"/> to the value of this instance.
        /// </summary>
        public static DateTimeOffset SubtractDateRange(this DateTimeOffset dateTimeOffset, DateRange timeSpan)
        {
